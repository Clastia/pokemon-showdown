...
export const Formats: FormatList = [
	...
	},
	{
		...
		mod: 'gen9',
		ruleset: ['Standard OMs', 'Tier Shift Mod', 'Evasion Clause', 'Sleep Moves Clause', 'Terastal Clause', 'Min Source Gen = 9'],
		banlist: [
			'Arceus', 'Calyrex-Ice', 'Calyrex-Shadow', 'Chi-Yu', 'Cloyster', 'Dialga', 'Dialga-Origin', 'Espathra', 'Eternatus', 'Falinks', 'Flutter Mane', 
			'Groudon', 'Giratina', 'Giratina-Origin', 'Iron Bundle', 'Koraidon', 'Kyogre', 'Landorus-Base', 'Medicham', 'Mewtwo', 'Miraidon', 
			'Oricorio-Pom-Pom', 'Palkia', 'Palkia-Origin', 'Polteageist', 'Rayquaza', 'Urshifu-Single-Strike', 'Zacian',  'Arena Trap', 'Moody', 'Shadow Tag', 
			'Eviolite', 'Damp Rock', 'Heat Rock', 'Light Clay', 'Baton Pass', 'Last Respects', 'Shed Tail', 
		],
	},
	{
